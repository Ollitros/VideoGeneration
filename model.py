...
class GAN:
    ...
    def build_generator(self):
        ...
        model.add(Dense(512 * 16 * 16, activation="relu", input_dim=self.latent_dim))
    ...
    def save_imgs(self, epoch):
        ...
        cv.imwrite('data/images/frame{epoch}.jpg'.format(epoch=epoch), gen_imgs[0] * 255)
        # Rescale images 0 - 1
    ...
    def train(self, train_x, epochs, batch_size=128, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if epoch % save_interval == 0:
                ...
                self.generator.save('data/model.h5')